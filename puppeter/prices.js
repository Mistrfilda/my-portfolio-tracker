...
async function processData(entries) {
	...
	for (const [index, entry] of entries.entries()) {
		...
		try {
			...
			var element = await page.waitForSelector("::-p-xpath(/html/body/div[2]/main/section/section/section/section/section[1]/div[2]/div[1]/section/div/section/div[1]/div[1]/span)")
